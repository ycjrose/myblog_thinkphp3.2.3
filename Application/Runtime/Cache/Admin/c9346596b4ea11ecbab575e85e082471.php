        ...
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="title_font_color">
                  <option value="">==请选择颜色==</option>
                    <?php if(is_array($titleFontColor)): $i = 0; $__LIST__ = $titleFontColor;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c1): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($news['title_font_color'] == $key): ?>selected="selected"<?php endif; ?>><?php echo ($c1); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="catid">
                  ...
                  <?php if(is_array($homeMenus)): $i = 0; $__LIST__ = $homeMenus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hm): $mod = ($i % 2 );++$i;?><option value="<?php echo ($hm["menu_id"]); ?>" <?php if($hm["menu_id"] == $news['catid']): ?>selected="selected"<?php endif; ?>><?php echo ($hm["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>  
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="copyfrom">
                  ...
                  <?php if(is_array($copyFrom)): foreach($copyFrom as $key=>$cf): ?><option value="<?php echo ($key); ?>" <?php if($news['copyfrom'] == $key): ?>selected="selected"<?php endif; ?>><?php echo ($cf); ?></option><?php endforeach; endif; ?>  
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <textarea class="input js-editor" id="editor_singcms" name="content" rows="20" value=""><?php echo ($news["content"]); ?></textarea>
              </div>
            </div>
            <div class="form-group">
...
<script>
  ...
  KindEditor.ready(function(K) {
    window.editor = K.create('#editor_singcms',{
      ...
      afterBlur : function(){this.sync();}, //为了使js能获取到textarea的值。
    });
  });
</script>
