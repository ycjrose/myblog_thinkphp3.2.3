              ...
              <div class="col-sm-5">
                <select class="form-control" name="title_font_color">
                  <option value="">==请选择颜色==</option>
                    <?php if(is_array($titleFontColor)): $i = 0; $__LIST__ = $titleFontColor;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c1): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($c1); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="catid">
                  ...
                  <?php if(is_array($homeMenus)): $i = 0; $__LIST__ = $homeMenus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hm): $mod = ($i % 2 );++$i;?><option value="<?php echo ($hm["menu_id"]); ?>"><?php echo ($hm["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>  
                </select>
              </div>
            </div>
